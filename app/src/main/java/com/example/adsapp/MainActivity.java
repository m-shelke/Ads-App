...
public class MainActivity extends AppCompatActivity {
    ...
    Button button, showIntersitialAdBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showIntersitialAdBtn = findViewById(R.id.showIntersitialAdBtn);
        ...
        showIntersitialAdBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
